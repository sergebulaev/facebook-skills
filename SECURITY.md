...
- **Preferred:** open a private report via
  [GitHub Security Advisories](https://github.com/sergebulaev/facebook-skills/security/advisories/new)
- **Alternative:** email `s@bulaev.org` with subject `[SECURITY] facebook-skills`
